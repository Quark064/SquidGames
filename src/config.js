...
const Sprite = {
    Path: [
        ...
        `${GameConst.Directory.Sprite}/snow.png`
    ],
    ...
    Common: {
        Snow:            new TileInfo(vec2(0, 0), vec2(240, 240), 3),
        LivesIcon:        new TileInfo(vec2(56, 32), vec2(8, 8), 2)
    },
    ...
    Jump: {
        ...
        NeedleFill:       new TileInfo(vec2(56, 24), vec2(8, 8), 2),
        NormalFloor:      new TileInfo(vec2(0, 32), vec2(8, 8), 2),
        BeltFloor:        new TileInfo(vec2(0, 40), vec2(8, 8), 2),
        SlipFloor:        new TileInfo(vec2(56, 40), vec2(8, 8), 2),

        JumpPlayer0:      new TileInfo(vec2(8, 32), vec2(16, 16), 2),
        JumpPlayer1:      new TileInfo(vec2(24, 32), vec2(16, 16), 2),
        JumpPlayer2:      new TileInfo(vec2(40, 32), vec2(16, 16), 2),
        JumpPlayer3:      new TileInfo(vec2(16, 48), vec2(16, 16), 2),
        JumpPlayer4:      new TileInfo(vec2(48, 48), vec2(16, 16), 2),
        JumpPlayerNoDot2: new TileInfo(vec2(0, 48), vec2(16, 16), 2),
        JumpPlayerNoDot3: new TileInfo(vec2(32, 48), vec2(16, 16), 2),

        Sparkle0:         new TileInfo(vec2(64, 0), vec2(16, 16), 2),
        Sparkle1:         new TileInfo(vec2(64, 16), vec2(16, 16), 2)
    }
}
...
const Audio = {
    Effect: {
        ...
        JumpJump:   new SoundWave(`${GameConst.Directory.AudioEffect}/Jump.mp3`)
    }
};
